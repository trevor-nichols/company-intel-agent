                  ...
                  {draft.map(item => (
                    ...
                    >
                      ...
                      <div className="mt-3 space-y-2">
                        <Input
                          value={item.title}
                          onChange={(event: ChangeEvent<HTMLInputElement>) => handleUpdate(item.id, { title: event.target.value })}
                        ...
                        <ScrollArea className="max-h-40 rounded-lg border border-border/20">
                          <Textarea
                            ...
                            onChange={(event: ChangeEvent<HTMLTextAreaElement>) => handleUpdate(item.id, { description: event.target.value })}
                            rows={4}
