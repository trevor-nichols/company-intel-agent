...
│   │   │   ├── SnapshotDetailsDialog/       # Modal dialog for displaying the details of a specific intel run.
│   │   │   │   ├── SnapshotDetailsDialog.tsx # The main dialog component for viewing snapshot details.
│   │   │   │   ├── components/              # Sub-components for the snapshot details dialog.
│   │   │   │   │   ├── ScrapeResults/       # Components for displaying web scrape results.
│   │   │   │   │   │   ├── ScrapeCard.tsx   # Card component for an individual scrape result.
│   │   │   │   │   │   ├── ScrapeFailureDetails.tsx # Displays diagnostics for a failed scrape attempt.
│   │   │   │   │   │   ├── ScrapeResults.tsx # Component that lists all scrape cards for a snapshot.
│   │   │   │   │   │   ├── ScrapeSuccessContent.tsx # Renders the content of a successful scrape.
│   │   │   │   │   │   └── index.ts         # Barrel file for scrape results components.
│   │   │   │   │   ├── SnapshotSummary.tsx  # Displays high-level metadata chips for a snapshot.
│   │   │   │   │   ├── SummariesSection/    # Components for displaying AI-generated summaries.
│   │   │   │   │   │   ├── MetadataBlock.tsx # Displays AI agent metadata (model, usage, etc.).
│   │   │   │   │   │   ├── StructuredProfileSummary.tsx # Renders the structured profile data from a snapshot.
│   │   │   │   │   │   ├── SummariesSection.tsx # Aggregates and displays all AI-generated summaries.
│   │   │   │   │   │   └── index.ts         # Barrel file for summaries section components.
│   │   │   │   │   ├── SummaryMetadataPanel.tsx # Panel that shows AI agent telemetry for debugging.
│   │   │   │   │   └── index.ts             # Barrel file for snapshot dialog sub-components.
│   │   │   │   ├── hooks/                   # React hooks specific to the snapshot details dialog.
│   │   │   │   │   └── useSnapshotDetails.ts # Hook to process and derive view models from raw snapshot data.
│   │   │   │   └── index.ts                 # Barrel file for the SnapshotDetailsDialog feature.
